...
class ZeroZeroOne extends React.Component {
  ...
  render() {
    ...
    const xinError = isFieldTouched("xin") && getFieldError("xin");
    const lastnameError =
      isFieldTouched("lastname") && getFieldError("lastname");
    const firstnameError =
      isFieldTouched("firstname") && getFieldError("firstname");
    const patronymicError =
      isFieldTouched("patronymic") && getFieldError("patronymic");
    // Patronymic не у всех есть
    const taxArticleIdError =
      isFieldTouched("taxArticleId") && getFieldError("taxArticleId");
    const postponeDatesError =
      isFieldTouched("postponeDates") && getFieldError("postponeDates");
    const postponeContinuationDatesError =
      isFieldTouched("postponeContinuationDates") &&
      getFieldError("postponeContinuationDates");
    const recommencementDateError =
      isFieldTouched("recommencementDate") &&
      getFieldError("recommencementDate");
    const OGDError =
      isFieldTouched("taxOrgCode") && getFieldError("taxOrgCode");
    const representativeNameError =
      isFieldTouched("representativeName") &&
              ...
              >
                <div className="tax form statement">
                  ...
                  >
                    ...
                    (продлении/возобновлении) представления налоговой отчетности
                  </div>
                  <div className="input group">
                    ...
                    <div className="label input" style={{ maxWidth: "100%" }}>
                      ...
                      обязательных платежах в бюджет» (Налоговый кодекс) прошу:
                    </div>
                  </div>
                  <div
                  ...
                  <div className="input group dates">
                    ...
                    <div className="ml-auto">
                      <Form.Item
                        validateStatus={recommencementDateError ? "error" : ""}
                  ...
                  <div className="input group">
                    ...
                    <div className="label input" style={{ maxWidth: "95%" }}>
                      ...
                      календарных дней со дня истечения срока ее представления,
                      установленного Налоговым кодексом, моя деятельность, как
                      индивидуального предпринимателя будет прекращена в
                      упрощенном порядке, установленном Налоговым кодексом.
                    </div>
                  </div>
                  <div
                    className="section header ta"
                  ...
                  <div className="input group">
                    ...
                    >
                      ...
                      достоверность и полноту сведений, приведенных в настоящем
                      налоговом заявлении.
                    </div>
                  </div>
                  <div
                  ...
                  >
                    ...
                    предпринимателями, применяющими специальный налоговый режим
                    для субъектов малого бизнеса на основе патента.
                    Возобновление деятельности такими расчета стоимости патента
                    на предстоящий период. плательщиками осуществляется при
                    подаче в органы государственных доходов
                  </div>
                </div>
              </div>
              <Button
